...
st.set_page_config(
    page_title="Bidirectional LSTM Sentiment Analysis",
    page_icon="🔄",
    layout="wide"
)

st.title("🔄 Bidirectional LSTM Sentiment Analysis")

st.markdown("""
This application uses a **Bidirectional LSTM (BiLSTM)** network
...
st.sidebar.subheader("🧠 BiLSTM Architecture")
...
st.markdown(
    "🚀 Built using TensorFlow, Bidirectional LSTM and Streamlit"
)